...
// @access   Public
router.get(url + '/user/:user_id', async (req, res) => {
    try {
        const profile = await Profile.findOne({
...
// @access   Private
router.delete(url + '/experience/:exp_id', auth, async (req, res) => {
    try {
...
// @access   Private
router.delete(url + '/education/:edu_id', auth, async (req, res) => {
    try {
        const profile = await Profile.findOne({ user: req.user.id });
...
// @access   Public
router.get(url + '/github/:username', async (req, res) => {
    // try {
    //   const options = {
